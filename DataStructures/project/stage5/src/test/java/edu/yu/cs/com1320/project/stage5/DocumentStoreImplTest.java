...
public class DocumentStoreImplTest {
    ...
    @Test
    public void pruebaConBefore() throws IOException {
        DocumentStore store = new DocumentStoreImpl();
        InputStream is1 = new ByteArrayInputStream(textoo1.getBytes());


        store.put(is1, urii1, TXT);
        assertEquals(store.get(urii1).getDocumentTxt(), textoo1);
    }

    @Test
    public void nothingTest() {
        String boca = "dale dale booo";
    }

    @Test
    public void nothingTest2() {
        String boca = "paso el segundo!";
    }
    ...
    @Test
    public void heap() throws URISyntaxException, IOException {
        DocumentStoreImpl store = new DocumentStoreImpl();
        URI uri1 = new URI("uri1");
        URI uri3 = new URI("uri3");
        URI uri5 = new URI("uri5");
        ...
        String string1 = "aauno";
        String string2 = "aados";
        String string3 = "aatres";
        String string4 = "cuatro";
        String string5 = "cinco";
        ...
        InputStream is4 = new ByteArrayInputStream(string4.getBytes());
        InputStream is5 = new ByteArrayInputStream(string5.getBytes());
        InputStream is6 = new ByteArrayInputStream(string1.getBytes());
        InputStream is7 = new ByteArrayInputStream(string2.getBytes());
        InputStream is8 = new ByteArrayInputStream(string3.getBytes());
        InputStream is9 = new ByteArrayInputStream(string4.getBytes());
        InputStream is10 = new ByteArrayInputStream(string5.getBytes());
   ...
   //     assertEquals(null, store.get(uri5));
        ...
        store.put(is6, uri1, TXT);
        store.put(is7, uri2, TXT);
        store.put(is8, uri3, TXT);
        store.put(is9, uri4, TXT);
        store.put(is10, uri5, TXT);

        store.undo(uri4);
        assertEquals(3, store.searchByPrefix("aa").size());
        assertEquals(1, store.searchByPrefix("cua").size());
    }
}