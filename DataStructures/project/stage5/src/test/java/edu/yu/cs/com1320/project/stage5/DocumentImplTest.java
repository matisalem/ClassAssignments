...
public class DocumentImplTest {
    ...
    public void secondTry() throws URISyntaxException{
        ...
        DocumentImpl documento3 = new DocumentImpl(uri2, texto2, null);
    ...
    public void brokenStuff() throws URISyntaxException, IllegalArgumentException{
        ...
        try {
            ...
            DocumentImpl documento4 = new DocumentImpl(uri1, falseText, null);
        ...
        try {
            DocumentImpl documento5 = new DocumentImpl(uri1, nullText, null);
        ...
        try {
            DocumentImpl documento5 = new DocumentImpl(uriEmpty, "hoho", null);
    ...
    public void wordsWithThings() throws URISyntaxException{
        ...
        DocumentImpl d1 = new DocumentImpl(uri1, texto1, null);
    ...
    @Test
    public void putWithMap() throws URISyntaxException{
        URI uri1 = new URI("first");
        // hay 5
        String texto1 = "uno dos tres cuatro ci-nco -seis siete- si-ete";
        ...
        DocumentImpl d1 = new DocumentImpl(uri1, texto1, hm);

        Map<String, Integer> mapa = d1.getWordMap();
